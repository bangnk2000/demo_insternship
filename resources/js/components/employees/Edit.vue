                        ...
                        <div class="card-body">
                            <form @submit.prevent="updateEmployee">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select v-model="form.country_id" @change="getStates()"
                                            id="country" name="country" class="form-control custom-select"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select v-model="form.state_id" @change="getCities()"
                                            id="state" name="state" class="form-control custom-select"
                                                aria-label="Default select example">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select v-model="form.city_id" id="city" name="city"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select v-model="form.department_id" id="department" name="department"
                                                class="form-control custom-select"
                                                aria-label="Default select example">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input v-model="form.zip_code" id="zip_code" type="text"
                                               class="form-control"
                                               value="" required autocomplete="last_name" autofocus>
